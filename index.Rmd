...
A day will consist in interactive demonstration lasting around 4 hours from 14:00-18:00. This will include worked examples to demonstrate concepts as well as problems to solve individually or in groups. Troubleshooting will take place throughout. Participants should have the most recent versions of `Rstudio` and `R` installed.

## Schedule 

This index is to be updated as materials are finalized. It's more for posterity than a prospective syllabus.

[Session 1](Session1) (Monday, 8 Nov)

1. [About me](Session#about-me)
2. [About this module](Session#about-this-module)
3. [Rmarkdown basics](Session#rmarkdown-basics)
4. [Tidyverse basics](Session#tidy-data)
5. [ggplot2 intro with gapminder](Session#basic-ggplot2-with-the-gapminder-data)
6. [dplyr intro](Session#basic-dplyr)
7. [UN fertility example](Session#examples)


[Session 2](Session2) (Tuesday, 9 Nov)

[Session 3](Session3) (Wednesday, 10 Nov)

[Session 4](Session4) (Thursday, 11 Nov)
